  ...
  'targets': [
    {
	  ...
	  ['OS!="win"', { 
		  ...
		  'sources': [
			...
			'<(glog_src_home)/linux/glog/raw_logging.h',
			'<(glog_src_home)/linux/glog/vlog_is_on.h',
			'<(glog_src_home)/linux/glog/stl_logging.h',
			'<(glog_src_home)/linux/glog/logging.h',
			'<(glog_src_home)/linux/glog/log_severity.h',
			...
			'sources': [				
				'<(glog_src_home)/windows/config.h',
				'<(glog_src_home)/windows/port.cc',
				'<(glog_src_home)/stacktrace_libunwind-inl.h',
				'<(glog_src_home)/utilities.cc',
				'<(glog_src_home)/windows/glog/raw_logging.h',
				'<(glog_src_home)/windows/glog/vlog_is_on.h',
				'<(glog_src_home)/windows/glog/stl_logging.h',
				'<(glog_src_home)/windows/glog/logging.h',
				'<(glog_src_home)/windows/glog/log_severity.h',
				'<(glog_src_home)/vlog_is_on.cc',
				'<(glog_src_home)/logging.cc',
				'<(glog_src_home)/utilities.h',
				'<(glog_src_home)/mock-log.h',
